#ifndef __ECT_sfun_h__
#define __ECT_sfun_h__
...
extern mxArray* load_ECT_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_ECT_optimization_info(void);
